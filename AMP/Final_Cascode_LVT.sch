...
C {devices/vsource.sym} -380 -90 0 0 {name=Vsrc_Vb3_Ideal value=0.95 savecurrent=false}
...
C {devices/vsource.sym} -500 -90 0 0 {name=Vsrc_Vb2_Ideal value=0.65 savecurrent=false}
...
C {devices/vsource.sym} -620 -90 0 0 {name=Vsrc_Vb1_Ideal value=1.15 savecurrent=false}
...
C {devices/vsource.sym} -980 -90 0 0 {name=Vsrc_vinp_cm_ideal1 value=0.55 savecurrent=false}
C {devices/vsource.sym} -820 -90 0 0 {name=Vsrc_vinp_cm_ideal value=0.55 savecurrent=false}
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 120 -50 0 1 {name=M2
L=0.15
W=1.02
nf=1
mult=16
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} -80 -470 0 1 {name=M7
L=0.35
W=1.32
nf=1
mult=32
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 80 -470 0 0 {name=M8
L=0.35
W=1.32
nf=1
mult=32
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} -220 110 0 1 {name=M9
L=0.15
W=1.05
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} -140 110 0 0 {name=M10
L=0.15
W=2.10
nf=1
mult=4
...
C {devices/lab_wire.sym} 120 180 0 1 {name=p43 sig_type=std_logic lab=agnd
}
